...
//    private static volatile JobLinkRoomDatabase jobLinkRoomDatabase;
    ...
    static JobLinkRoomDatabase getDatabase(final Context context) {
...
//                            .build();
    ...
    private static class PopulateDbAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            userDao.deleteAll();
            jobDao.deleteAll();
//            User directorOne = new User("Adam McKay");
//            User directorTwo = new User("Denis Villeneuve");
//            User directorThree = new User("Morten Tyldum");
...
//            userDao.insert(movieOne, movieTwo, movieThree, movieFour);
            return null;
        }
    }
